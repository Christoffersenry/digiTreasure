...
import { FontAwesomeIcon } from "@fortawesome/react-fontawesome";           // Icon imported from fontawesome
import { faWallet, faCircleDot } from "@fortawesome/free-solid-svg-icons";  // Icons imported from fontawesome
const Header: NextPage = () => {
  ...
  const [display, setDisplay] = useState<string>("hidden w-full sm:inline-flex sm:flex-grow sm:w-auto");
  
  const toggleMenu = () => {
    console.log("Button was clicked");
    if (display == "hidden w-full sm:inline-flex sm:flex-grow sm:w-auto") {
      setDisplay("block w-full sm:inline-flex sm:flex-grow sm:w-auto");
    } else {
      setDisplay("hidden w-full sm:inline-flex sm:flex-grow sm:w-auto");
    }
        ...
        <div id="menu" className={display}>
          ...
          <Link href="/explore">
            ...
            <div className="group menuItem">
              ...
              <button className="font-bold sm:hidden sm:navBadge" onClick={login}>Connect Wallet
              </button>
            </div>
            <Link href="/creatorsdashboard">
              <div className="relative group menuItem">
                ...
                <span className="w-24 sm:hidden sm:navBadge">Dashboard</span>
              </div>
            </Link>
          </div>
        </div>
