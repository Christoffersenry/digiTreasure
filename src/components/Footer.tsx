...
import { FontAwesomeIcon } from "@fortawesome/react-fontawesome";     // Icon imported from Font Awesome
import {
  faYoutube,
  faFacebook,
  faTwitter,
  faLinkedin,
} from "@fortawesome/free-brands-svg-icons";            // Icons imported from Font Awesome
              ...
              <li className="flex items-center">
                <div className="flex items-center">
                  ...
                  <div className="pt-2 pl-6 pr-1">
                    ...
                    <a target="_blank" rel="noreferrer" href="https://icons8.com/icon/tocgjtmSkmsT/copyright-all-rights-reserved">
